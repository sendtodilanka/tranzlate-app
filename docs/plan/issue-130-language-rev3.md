...
| PR-16 | 17c/17d dialog host + docked "Manage packs" ordering + **E-D1 ran and PASSED at both sizes** + the jank budget **measured and reported unsatisfiable on an emulator** (see below) | 🔨 branch `feat/issue-130-pr16-dialog` |
