...
| PR-19 | 19f + 19g + U-10 saved-count query + the 🗑 becomes a confirmed remove. **No fallback is built: the drawn 19g and ruling 3 both describe a target switch this app does not have** — deviations below | 👁 #227 |
