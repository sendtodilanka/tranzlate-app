 ...
 */
internal fun normalizeSourceText(raw: String): String =
...
class TranslationRepositoryImpl @Inject constructor(
    ...
    override suspend fun save(translation: Translation): Long =
        translationDao.insert(translation.toEntity())
...
private fun TranslationEntity.toDomain(): Translation = Translation(
    id = id,
...
private fun Translation.toEntity(): TranslationEntity = TranslationEntity(
    id = id,
    sourceLang = sourceLang,
