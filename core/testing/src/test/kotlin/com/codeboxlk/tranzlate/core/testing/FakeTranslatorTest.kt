...
class FakeTranslatorTest {
    ...
    @Test
    fun `G1 en-fr ML2_MINI returns exact golden output`() =
        runTest {
    ...
    @Test
    fun `G2 AUTO resolves offline-first with same golden output`() =
        runTest {
    ...
    @Test
    fun `G3 NLP35 returns the distinct advanced output`() =
        runTest {
    ...
    @Test
    fun `G7 auto source detects and translates`() =
        runTest {
    ...
    @Test
    fun `G8 pair without golden row is UNSUPPORTED_PAIR`() =
        runTest {
    ...
    @Test
    fun `input is trimmed before golden lookup`() =
        runTest {
            val outcome = translator.translate("  Good morning  ", "en", "fr", ModeId.ML2_MINI)
